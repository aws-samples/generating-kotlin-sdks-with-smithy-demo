...
pub async fn de_delete_leaderboard_http_request<B>(
...
where
    ...
    Ok({
        #[allow(unused_mut)]
        let mut input = crate::input::delete_leaderboard_input::Builder::default();
        ...
        input = input.set_id(
                                        crate::protocol_serde::shape_delete_leaderboard_input::de_id(m1)?
                                    );
        input.build()?
    })
}
...
#[allow(clippy::unnecessary_wraps)]
pub fn ser_delete_leaderboard_http_response(
    #[allow(unused_variables)] output: crate::output::DeleteLeaderboardOutput
) -> std::result::Result<
...
#[allow(clippy::unnecessary_wraps)]
pub fn ser_delete_leaderboard_http_error(error: &crate::error::DeleteLeaderboardError) -> std::result::Result<::aws_smithy_http_server::response::Response, ::aws_smithy_http_server::protocol::rest_json_1::rejection::ResponseRejection> {
    Ok({
        match error {
            crate::error::DeleteLeaderboardError::NotFoundError(output) => {
            ...
            crate::error::DeleteLeaderboardError::ValidationException(output) => {
