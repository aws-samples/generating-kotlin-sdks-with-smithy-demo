...
pub async fn de_get_leaderboard_http_request<B>(
...
where
    ...
    Ok({
        #[allow(unused_mut)]
        let mut input = crate::input::get_leaderboard_input::Builder::default();
        ...
        input = input.set_id(
                                        crate::protocol_serde::shape_get_leaderboard_input::de_id(m1)?
                                    );
        input.build()?
    })
}
...
#[allow(clippy::unnecessary_wraps)]
pub fn ser_get_leaderboard_http_response(
    #[allow(unused_variables)] output: crate::output::GetLeaderboardOutput
) -> std::result::Result<
...
> {
    Ok({
        ...
        let payload =
            crate::protocol_serde::shape_get_leaderboard_output::ser_get_leaderboard_output_output_output(&output)?
        ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn ser_get_leaderboard_http_error(error: &crate::error::GetLeaderboardError) -> std::result::Result<::aws_smithy_http_server::response::Response, ::aws_smithy_http_server::protocol::rest_json_1::rejection::ResponseRejection> {
    Ok({
        match error {
            crate::error::GetLeaderboardError::ValidationException(output) => {
            ...
            crate::error::GetLeaderboardError::NotFoundError(output) => {
